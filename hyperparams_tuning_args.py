...
def create_tuning_args():
    ...
    parser.add_argument('--colate_fn', type=str, default="completion", help="collate_fn for training")
    ...
    # TRAINING_PARAMS
    parser.opt_list('--learning_rate', type=float, default=1.41e-4, tunable=True, options=[1e-5, 5e-5, 1e-4, 5e-4], help="the learning rate")
